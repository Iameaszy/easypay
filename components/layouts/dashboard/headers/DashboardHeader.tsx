        ...
        <Show above="sm">
          ...
          >
            <Box display="flex" color='#152c5b'>
              <NavLink fontWeight='bold'  padding="30px" text="Contact Us" path="#contact" />
              <NavLink fontWeight='bold' padding="30px" text="FAQ" path="#faq" />
              <NavLink fontWeight='bold' padding="30px" text="Help" path="#help" />
            </Box>
            <Box w="15rem" display="flex" alignItems="center">
              <NavLink fontWeight='bold' w='50.5%' padding="30px" text="Sign In" path="#sign in" />
