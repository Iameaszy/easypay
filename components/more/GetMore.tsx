...
const GetMore = () => {
    return (
        ...
        <Box width='25%'>
            ...
            <Image margin='-5% 0 0 -5%' alt="Green checkmark" src='SkeletonCheck.svg' width='8%' height='8%' color='mediumseagreen' /><Text color='#8a95ad' fontSize='70%' position='relative' top='-8%' left='8%'>Low interest salary advance</Text>
            <Image margin='5% 0 0 -5%' alt="Green checkmark" src='SkeletonCheck.svg' width='8%' height='8%' color='mediumseagreen' /><Text color='#8a95ad' fontSize='70%' position='relative' top='-13%' left='8%'>We provide your pay evidence to lending platforms</Text>
        </Box>
        <Box width='25%'>
            ...
            <Tabs variant='unstyled'>
                <TabPanels lineHeight='1.6em' fontSize='100%' color='#8a95ad' margin='0% 0 7% -3%'>
                    <TabPanel>
                        ...
                        <Text as='q' fontStyle='italic' fontSize='70%' fontWeight='bold' margin='0% 0 7% -3%'>The fact I can get salary in USD and also sell at a good exchange rate on the same platform  and still have a USD salary account makes Geegpay the best. Salary advance also makes my life easier. Thanks Geegpay &#10084;</Text>
