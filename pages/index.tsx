    ...
    <>
      ...
      <MainDashboard>
        ...
        <Flex position='relative' z-index='10' flexDirection='row' justifyContent='space-between'>
          <Box w='100%'>
            <Text bg='white' color='dodgerblue' boxShadow='-0px 5px 0px 0.01px hsl(0.00,0.00%,98.5%)' borderRadius='20px' p='2% 10% 2% 2%' fontSize='70%' m='0 49% 3% 3%'><CheckCircleIcon margin='-2% 6% 0 0' />Get paid in minutes</Text>
            <Heading m='0 0 6% 0'  color='#152c5b'>Digital Financial <br /> Platform for the Gig <br /> Econonomy.</Heading>
